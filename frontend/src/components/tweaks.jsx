// Tweaks panel — host-integrated, dev-only.
// Lifted from AlphaSwarm-2/src/tweaks.jsx (W2 Plan 41.6-02 task 2) and
// converted to ES modules per D-03. The dev-only mount gate lives in
// TweaksPanelLoader.tsx (sibling).
