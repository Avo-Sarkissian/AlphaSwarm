...
class TestSuspendResume:
    ...
    @pytest.mark.asyncio
    async def test_resume_unblocks_acquire(self) -> None:
        gov = self._make_governor()
        gov.suspend()
        ...
        del token  # acquired slot; release not strictly needed for this test
        gov.release()

    @pytest.mark.asyncio
    async def test_suspend_does_not_touch_state_machine(self) -> None:
        gov = self._make_governor()
    ...
    @pytest.mark.asyncio
    async def test_monitor_loop_continues_during_suspend(self) -> None:
    ...
    @pytest.mark.asyncio
    async def test_suspend_does_not_bypass_memory_pressure_state(self) -> None:
