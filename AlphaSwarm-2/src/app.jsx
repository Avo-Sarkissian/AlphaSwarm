  ...
  return (
    <div className="app" data-dir="a" data-density={state.density} data-screen-label="01 Dashboard">
      ...
      <div className="topbar">
        ...
        <button className="btn ghost-btn" onClick={() => setUi(u => ({...u, cyclePickerOpen: true}))} title="Replay past cycle">
          <Icon name="replay" />
        </button>
      ...
      {ui.reportOpen && <ReportModal onClose={() => setUi(u => ({...u, reportOpen: false}))} />}
