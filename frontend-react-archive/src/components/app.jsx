// Main app — reference (v1) shell.
// WAVE-1-NOTE: This is the v1 dashboard. The actually-mounted AppShell is
// `app_v2.jsx`. This file is retained from the design drop so the v1 layout
// remains available for reference; it is NOT wired into the render tree in
// Wave 1. Behavioural notes:
...
//     AgentsContext into AppShell.tsx which supersedes this reference copy.
...
export function App() {
  ...
  // WAVE-1-NOTE: `buildAgents` removed. Wave 2 wires AgentsContext into this
  // component. Until then, dashboard renders an empty swarm.
