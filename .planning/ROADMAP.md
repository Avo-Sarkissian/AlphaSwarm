...
Plans:
- [ ] 34-01-PLAN.md -- ReplayManager class, replay route implementations, broadcaster coupling, Wave 0 tests
- [ ] 34-02-PLAN.md -- CSS tokens, CyclePicker.vue modal, ControlBar replay strip, ForceGraph edge-clear fix, App.vue wiring
- [ ] 34-03-PLAN.md -- Human verification of replay mode in browser
