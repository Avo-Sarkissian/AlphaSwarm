...
Plans:
- [ ] 35-01-PLAN.md -- Interview route, tests, lifespan wiring (backend)
- [ ] 35-02-PLAN.md -- InterviewPanel.vue, AgentSidebar button, App.vue wiring (frontend)
- [ ] 35-03-PLAN.md -- Human verification of interview flow in browser
