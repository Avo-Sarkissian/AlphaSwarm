...
**Plans:** 3 plans
Plans:
- [ ] 29-01-PLAN.md — Install deps + StateStore non-destructive refactor + TUI call site update
- [ ] 29-02-PLAN.md — web/ package scaffold (app factory, lifespan, health endpoint, SimulationManager, ConnectionManager) + tests
...
| 29. FastAPI Skeleton and Event Loop Foundation | v5.0 | 0/3 | Planning | - |
