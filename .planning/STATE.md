...
Phase: 10 (tui-panels-and-telemetry) — EXECUTING
Plan: 2 of 2
...
- [Phase 10]: BracketSummary moved from simulation.py to state.py: StateSnapshot needs BracketSummary at runtime, avoiding circular import
